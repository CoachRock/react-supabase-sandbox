...
export default function CompletedInterviews() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        heading="Completed Interviews" 
        description="Candidates who have completed their Alpha Interview" 
      />
      ...
      <div className="space-y-4">
        ...
        <h3 className="text-xl font-semibold text-blue-500">Candidates Ready for Review</h3>
            ...
            <TableBody>
              {filteredCandidates.map((candidate) => (
                <TableRow key={candidate.id}>
                  ...
                  <TableCell className="text-center">
                    <Link href="/individual-evaluation">
