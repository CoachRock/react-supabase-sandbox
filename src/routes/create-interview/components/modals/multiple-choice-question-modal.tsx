...
export function MultipleChoiceQuestionModal({ children, onQuestionAdd }: MultipleChoiceQuestionModalProps) {
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="flex justify-end">
            <Button
              ...
              disabled={!question || !optionA || !optionB || !correctAnswer || !prepTime || !answerTime}
            >
              Submit
            </Button>
          </div>
